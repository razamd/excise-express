class MongooseService {
  ...
  pagination(options , aggregatePagination){
    return this.model.aggregatePaginate(aggregatePagination, options);
  }

  aggregateTry ( aggregations ) {
    return this.model.aggregate(aggregations);
  }

  delete ( id,  options = { lean: true, new: true } ) {
    return this.model
      .findByIdAndUpdate( id, {active : false}, options )
      .exec();
  }

  updateWithQuery ( query, body, options = { lean: true, new: true } ) {
    return this.model
